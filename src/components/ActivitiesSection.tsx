    ...
    <section id="activities" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center space-y-6 mb-20">
          <Badge
            variant="outline"
            className="w-fit mx-auto px-4 py-2 bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/30 backdrop-blur-sm"
          >
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {sharingTopics.map((topic, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-card via-card to-muted/10 group border border-border/20 backdrop-blur-sm"
                >
                  <CardHeader className="pb-4">
                    <div
                      className={`w-16 h-16 mx-auto ${topic.bg} rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20`}
                    >
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {activities.map((activity, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="overflow-hidden border-0 shadow-xl bg-gradient-to-br from-card via-card to-muted/10 hover:shadow-2xl transition-all duration-500 group border border-border/20 backdrop-blur-sm"
                >
                  <div className="aspect-video relative overflow-hidden">
                    ...
                    <div className="absolute top-6 left-6">
                      <div
                        className={`w-12 h-12 bg-gradient-to-br ${activity.gradient} backdrop-blur-xl rounded-xl flex items-center justify-center border border-white/30 shadow-xl`}
                      >
